...
name: "gen-nitro", 
code: `
$channelSendMessage[$getVar[logschannel];{description: **$username#$discriminator ($authorID)** ha generado un código nitro en el servidor **"$serverName"** En total ha generado $getGlobalUserVar[usergencount] cuentas}{color:GREEN}]
...
**(Nota: la mayoría de códigos no funcionarán)**
**¡Se han añadido 10 lanos a tu saldo del bot!**

**Aquí está tu código:** https://discord.gift/$randomString[16]
...
$sendMessage[{description:**Generando un código nitro...**}{color:#ffff00}{footer: Desarrollado por HuguitisYT#1234}{delete:4s};no]
