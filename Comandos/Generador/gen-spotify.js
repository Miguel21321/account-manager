...
name: "gen-spotify", 
code: `
$channelSendMessage[$getVar[logschannel];{description: **$username#$discriminator ($authorID)** ha generado una cuenta de spotify en el servidor **"$serverName"** En total ha generado $getGlobalUserVar[usergencount] cuentas}{color:GREEN}]
...
**Aquí está tu cuenta:** $randomText[$readFile[./Cuentas/cuentas-spotify.txt]]
**Tipo:** Spotify
}{color:GREEN}{footer: Desarrollado por HuguitisYT#1234}]

$wait[4s]

$sendMessage[{description:<a:cargando2:858715584691044402> **Generando una cuenta de Spotify...**}{color:#ffff00}{footer: Desarrollado por HuguitisYT#1234}{delete:4s};no]
