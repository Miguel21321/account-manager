...
name: "gen-steam", 
code: `
$channelSendMessage[$getVar[logschannel];{description: **$username#$discriminator ($authorID)** ha generado una cuenta de steam en el servidor **"$serverName"** En total ha generado $getGlobalUserVar[usergencount] cuentas}{color:GREEN}]
...
**Aquí está tu cuenta:** $randomText[$readFile[./Cuentas/cuentas-steam.txt]]
**Tipo:** Steam
}{color:GREEN}{footer: Desarrollado por HuguitisYT#1234}]

$wait[4s]

$sendMessage[{description:**Generando una cuenta de Steam...**}{color:#ffff00}{footer: Desarrollado por HuguitisYT#1234}{delete:4s};no]
